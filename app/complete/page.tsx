  ...
  return (
    <main className="page-shell">
      <div className="hero">
        ...
        <h1>Complete</h1>
        <p>
          This is the terminal target after{" "}
          <code>verify -&gt; onboarding -&gt; complete</code>.
        </p>
      </div>
        ...
        <div className="panel stack">
          <div>
            ...
            <div className="inline-list">
              <div>
                <code>Go to dashboard again</code> should keep routing back here
                while the cookie state remains <code>complete</code>.
              </div>
              <div>
                Use reset to restart the cycle from <code>verify</code>.
              </div>
            </div>
          </div>
          <div className="button-row">
            <GoToDashboardButton label="Go to dashboard again" />
